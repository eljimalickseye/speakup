      ...
      @if (activeTab() === 'create') {
        <div class="card" style="border: 1px solid var(--border); border-radius: 12px; padding: 24px; background: var(--surface-1); box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
          <h3 class="st" style="font-size:16px; margin: 0 0 16px 0; display:flex; align-items:center; gap:8px; color: var(--text-primary); font-weight: 700;">
            ...
            {{ selectedGameId() ? 'Modifier le Jeu de Vocabulaire' : 'Créer un Jeu de Vocabulaire' }}
          </h3>

          <!-- Game Title -->
          <div class="input-row" style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 16px;">
            <label for="gameTitle" style="font-size: 12px; font-weight: 600; color: var(--text-secondary);">Titre du jeu</label>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
            ...
            <div class="input-row" style="display: flex; flex-direction: column; gap: 6px;">
              <label for="gameType" style="font-size: 12px; font-weight: 600; color: var(--text-secondary);">Type de jeu</label>
            ...
            <!-- Difficulty -->
            <div class="input-row" style="display: flex; flex-direction: column; gap: 6px;">
              <label for="gameDiff" style="font-size: 12px; font-weight: 600; color: var(--text-secondary);">Difficulté</label>
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:20px">
            <!-- Category -->
            <div class="input-row" style="display: flex; flex-direction: column; gap: 6px;">
              <label for="gameCategory" style="font-size: 12px; font-weight: 600; color: var(--text-secondary);">Catégorie</label>
            ...
            <!-- Group Assignment -->
            <div class="input-row" style="display: flex; flex-direction: column; gap: 6px;">
              <label for="gameGroup" style="font-size: 12px; font-weight: 600; color: var(--text-secondary);">Assigner au groupe (optionnel)</label>
          ...
          <div style="display:flex; justify-content:flex-end; gap:12px; margin-top:24px; padding-top:16px; border-top:1px solid var(--border-weak)">
            @if (selectedGameId()) {
              <button class="btn-s" (click)="resetForm()" style="border: 1px solid var(--border); border-radius: 8px; padding: 8px 16px; cursor: pointer; background: none; font-weight: 600; color: var(--text-secondary);">Annuler</button>
            }
            <button class="btn-p" [disabled]="!isValid()" (click)="saveGame()" style="background:#F59E0B; border-color:#F59E0B; color: white; border-radius: 8px; padding: 8px 24px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 6px;">
              ...
              {{ selectedGameId() ? 'Mettre à jour le jeu' : 'Publier le jeu' }}
            </button>
          </div>
        </div>
      }
...
print("vocab-games.ts updated successfully!")
