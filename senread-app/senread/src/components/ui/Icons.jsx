...
export function MinimizeIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 14H4m0 0v5m0-5l5 5m6-5h5m0 0v5m0-5l-5 5M9 10H4m0 0V5m0 5l5-5m6 5h5m0 0V5m0 5l-5-5" />
    </svg>
  );
}
...
export function HeartIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-4.5-4.5c-1.378 0-2.6.657-3.375 1.684A4.5 4.5 0 004.318 6.318z" />
    </svg>
  );
}
